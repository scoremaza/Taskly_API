...
class IsAllowedToEditTaskListElseNone(permissions.BasePermission):
    """
    Custom permissions for TaskListViewSet to only allow
    the creator editing permission.
    """
...
class IsAllowedToEditTaskElseNone(permissions.BasePermission):
    """
    Custom permissions for TaskViewSet to only allow
    members of a house access to its tasks.
    """
